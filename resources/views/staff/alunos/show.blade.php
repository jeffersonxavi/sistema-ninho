                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6 border-b pb-4">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <a href="{{ route('staff.alunos.edit', $aluno->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-md shadow-sm transition duration-150">
                                Editar Dados
                            </a>
                            <a href="{{ route('staff.alunos.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-md shadow-sm transition duration-150">
                                Voltar
                            </a>
                        </div>
                    </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="{{ $pagamento->status == 'Atrasado' ? 'bg-red-50' : ($pagamento->status == 'Pago' ? 'bg-green-50' : '') }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('staff.pagamentos.show', $pagamento->id) }}" class="text-indigo-600 hover:text-indigo-900">Gerenciar Pagamento</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
