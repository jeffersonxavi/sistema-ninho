            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('staff.alunos.create') }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md shadow-sm transition duration-150">
                            + Novo Aluno
                        </a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            @if ($aluno->contrato_gerado)
                                                <a href="{{ route('staff.alunos.contrato.download', $aluno->id) }}" 
                                            ...
                                            <a href="{{ route('staff.alunos.show', $aluno->id) }}" 
                                            ...
                                            {{-- 3. BOTÃO EDITAR --}}
                                            <a href="{{ route('staff.alunos.edit', $aluno->id) }}" 
                                            ...
                                            <form action="{{ route('staff.alunos.destroy', $aluno->id) }}" method="POST" class="inline" onsubmit="return confirm('Tem certeza que deseja excluir este aluno e todos os seus pagamentos? Esta ação não pode ser desfeita.')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
